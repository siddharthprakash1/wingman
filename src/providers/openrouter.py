...
Connects to OpenRouter API for access to hundreds of models.
...
class OpenRouterProvider(LLMProvider):
    ...
    def __init__(self, api_key: str, api_base: str = "https://openrouter.ai/api/v1", model: str = ""):
        ...
        if self._client is None:
            self._client = httpx.AsyncClient(
                ...
                headers={
                    ...
                    "HTTP-Referer": "https://github.com/openclaw-mine",
                    "X-Title": "OpenClaw Mine",
